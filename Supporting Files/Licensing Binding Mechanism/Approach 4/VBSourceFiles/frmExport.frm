...
Begin VB.Form frmRequest 
   ...
   Caption         =   "Request Tally - Approach 4"
   ClientHeight    =   4260
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6165
...
Private Declare Function DecryptStr Lib "CallDLLEncDec.dll" _
...
strXmldata = _
    ...
    "<ID>Sec XML Request4</ID>" & vbCrLf & _
    "</HEADER>" & vbCrLf & _
    "<BODY>" & vbCrLf & _
    "<DESC>" & _
    "<STATICVARIABLES>" & _
